...
def test_process_event_tracker():
    ...
    assert result.returncode == 0, f"Process failed with return code {result.returncode}. Output: {result.stdout}, Error: {result.stderr}"

if __name__ == "__main__":
    test_process_event_tracker()
